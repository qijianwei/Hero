...
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    class Platform {
        ...
        onShareAppMessage(listener) {
            qq.onShareAppMessage(listener);
        }
        shareAppMessage(params) {
            qq.shareAppMessage(params);
        }
        getShareInfo(params) {
            qq.getShareInfo(params);
        }
        setKeepScreenOn() {
            qq.setKeepScreenOn({
                keepScreenOn: true,
        ...
        onAudioInterruptionBegin(listener) {
            qq.onAudioInterruptionBegin(listener);
        }
        onAudioInterruptionEnd(listener) {
            qq.onAudioInterruptionEnd(listener);
        }
        /**network */
        onNetworkStatusChange(listener) {
            qq.onNetworkStatusChange(listener);
        }
        offNetworkStatusChange(listener) {
            qq.offNetworkStatusChange(listener);
        }
        getNetworkType(params) {
            qq.getNetworkType(params);
        }
        /**支付 */
        ...
        setUserCloudStorage(params) {
            qq.setUserCloudStorage(params);
        }
        openCustomerServiceConversation() {
            qq.openCustomerServiceConversation();
        }
        previewImage(params) {
            qq.previewImage(params);
        }
        setClipboardData(params) {
            qq.setClipboardData(params);
        }
    }
    ...
    class UpdateManager {
        constructor() {
            if (!Object(_APIEnable__WEBPACK_IMPORTED_MODULE_0__["default"])('getUpdateManager'))
                return this;
            let update = qq.getUpdateManager();
                        ...
                        if (params.requestUserInfo) {
                            LoginManager.getUserInfo(userInfo => {
                                cb({
                                    ...
                                    platform: 8,
                                    js_code: code,
                                    device_info: qq.getSystemInfoSync(),
    ...
    class BannerAd {
        constructor(params) {
            ...
            let bannerAd = qq.createBannerAd(params);
    ...
    class RewardedVideoAd {
        constructor(params) {
            if (!Object(_APIEnable__WEBPACK_IMPORTED_MODULE_0__["default"])('createRewardedVideoAd'))
                return this;
            let videoAd = qq.createRewardedVideoAd(params);
