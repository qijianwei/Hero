...
http.open("GET","http://apis.juhe.cn/lottery/history?key=e0a95b3906ce0e3888d3aac2049a15bc&lottery_id=dlt&page_size=8&page=1");
http.send();
http.onreadystatechange=function(){
    ...
    if(this.readyState == 4 && this.status == 200) {
        lottoResponse(JSON.parse(this.responseText).result.lotteryResList) 
    }
}
